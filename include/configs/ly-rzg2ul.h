...
#ifndef __LY_RZG2UL_H
#define __LY_RZG2UL_H
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"emmcload=fatload mmc 0:1 0x48080000 Image;fatload mmc 0:1 0x48000000 ly-rzg2ul.dtb;run prodemmcbootargs \0" \
	"bootcmd_check=if mmc dev 0; then run emmcload; fi \0" \
	"usbpart=0:1\0" \
	"usbload=usb start;fatload usb ${usbpart} 0x48080000 boot/Image;fatload usb ${usbpart} 0x48000000 boot/ly-rzg2ul.dtb;fatload usb ${usbpart} 0x50000000 boot/RZG2UL-LY.cpio.gz.u-boot;setenv bootargs rdinit=/sbin/init;booti 0x48080000 0x50000000 0x48000000 \0"
