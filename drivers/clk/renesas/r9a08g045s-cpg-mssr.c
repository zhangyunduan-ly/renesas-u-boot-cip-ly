...
static const struct cpg_core_clk r9a08g045s_core_clks[] = {
	...
	/* Internal Core Clocks */
	DEF_FIXED(".osc", R9A08G045_OSCCLK, CLK_XINCLK, 1, 1),
	DEF_FIXED(".osc2", R9A08G045_OSCCLK2, CLK_XINCLK, 1, 3),
	...
	/* Core output clk*/
	DEF_DIV("I", R9A08G045_CLK_I, CLK_PLL1, DIVPL1,
		div_table_1_8, CLK_DIVIDER_HIWORD_MASK),
	DEF_DIV("P0", R9A08G045_CLK_P0, CLK_PLL2_DIV2_8, DIVPL2B,
	...
	DEF_DIV("SD0", R9A08G045_CLK_SD0, CLK_SEL_SDHI0, DIV_SDHI0_G3S,
		div_table_1_2, CLK_DIVIDER_HIWORD_MASK),
	DEF_DIV("SD1", R9A08G045_CLK_SD1, CLK_SEL_SDHI1, DIV_SDHI1_G3S,
		div_table_1_2, CLK_DIVIDER_HIWORD_MASK),
	DEF_DIV("SD2", R9A08G045_CLK_SD2, CLK_SEL_SDHI2, DIV_SDHI2_G3S,
		div_table_1_2, CLK_DIVIDER_HIWORD_MASK),
	DEF_FIXED("M0", R9A08G045_CLK_M0, CLK_PLL3_DIV2, 1, 4),
	DEF_DIV("P1", R9A08G045_CLK_P1, CLK_PLL3_DIV2_4, DIVPL3A,
		div_table_1_32, CLK_DIVIDER_HIWORD_MASK),
	DEF_DIV("P2", R9A08G045_CLK_P2, CLK_PLL3_DIV2_8, DIVPL3B,
		div_table_1_32, CLK_DIVIDER_HIWORD_MASK),
	DEF_DIV("P3", R9A08G045_CLK_P3, CLK_PLL3_DIV2_4, DIVPL3C,
		div_table_1_32, CLK_DIVIDER_HIWORD_MASK),
	DEF_FIXED("AT", R9A08G045_CLK_AT, CLK_PLL3_DIV2, 1, 2),
	DEF_FIXED("ZT", R9A08G045_CLK_ZT, CLK_PLL3_DIV2, 1, 8),
	DEF_DIV("OC0", R9A08G045_CLK_OC0, CLK_SEL_OCTA, DIV_OCTA_G3S,
		div_table_1_32, CLK_DIVIDER_HIWORD_MASK),
	DEF_FIXED("OC1", R9A08G045_CLK_OC1, R9A08G045_CLK_OC0, 1, 2),
	DEF_DIV("SPI0", R9A08G045_CLK_SPI0, CLK_SEL_SPI, DIV_SPI_G3S,
		div_table_1_32, CLK_DIVIDER_HIWORD_MASK),
	DEF_FIXED("SPI1", R9A08G045_CLK_SPI1, R9A08G045_CLK_SPI0, 1, 2),
	DEF_FIXED("S0", R9A08G045_CLK_S0, CLK_SEL_PLL4, 1, 2),
	DEF_DIV("I2", R9A08G045_CLK_I2, CLK_PLL6_DIV2, DIVPL6A_G3S,
		div_table_1_32, CLK_DIVIDER_HIWORD_MASK),
	DEF_DIV("I3", R9A08G045_CLK_I2, CLK_PLL6_DIV2, DIVPL6B_G3S,
		div_table_1_32, CLK_DIVIDER_HIWORD_MASK),
	DEF_FIXED("HP", R9A08G045_CLK_HP, CLK_PLL6_DIV2, 1, 1),
};

static struct mssr_mod_clk r9a08g045s_mod_clks[] = {
	DEF_MOD("gic",		R9A08G045_GIC600_GICCLK,
				R9A08G045_CLK_P1,
				MSSR(5, BIT(0), (BIT(0) | BIT(1)))),
	DEF_MOD("ia55",		R9A08G045_IA55_CLK,
				R9A08G045_CLK_P1,
				MSSR(6, (BIT(0) | BIT(1)), BIT(0))),
	DEF_MOD("mhu",		R9A08G045_MHU_PCLK,
				R9A08G045_CLK_P1,
				MSSR(8, BIT(0), BIT(0))),
	DEF_MOD("dmac",		R9A08G045_DMAC_ACLK,
				R9A08G045_CLK_P3,
				MSSR(11, (BIT(0) | BIT(1)),
					 (BIT(0) | BIT(1)))),
	DEF_MOD("sysc",		R9A08G045_SYC_CNT_CLK,
				CLK_XINCLK,
				MSSR(12, (BIT(0) | BIT(1)),
					 (BIT(0) | BIT(1) | BIT(2)))),
	DEF_MOD("ostm0",	R9A08G045_OSTM0_PCLK,
				R9A08G045_CLK_P0,
				MSSR(13, BIT(0), BIT(0))),
	DEF_MOD("ostm1",	R9A08G045_OSTM1_PCLK,
				R9A08G045_CLK_P0,
				MSSR(13, BIT(1), BIT(1))),
	DEF_MOD("ostm2",	R9A08G045_OSTM2_PCLK,
				R9A08G045_CLK_P0,
				MSSR(13, BIT(2), BIT(2))),
	DEF_MOD("ostm3",	R9A08G045_OSTM3_PCLK,
				R9A08G045_CLK_P0,
				MSSR(13, BIT(3), BIT(3))),
	DEF_MOD("ostm4",	R9A08G045_OSTM4_PCLK,
				R9A08G045_CLK_P0,
				MSSR(13, BIT(4), BIT(4))),
	DEF_MOD("ostm5",	R9A08G045_OSTM5_PCLK,
				R9A08G045_CLK_P0,
				MSSR(13, BIT(5), BIT(5))),
	DEF_MOD("ostm6",	R9A08G045_OSTM6_PCLK,
				R9A08G045_CLK_P0,
				MSSR(13, BIT(6), BIT(6))),
	DEF_MOD("ostm7",	R9A08G045_OSTM7_PCLK,
				R9A08G045_CLK_P0,
				MSSR(13, BIT(7), BIT(7))),
	DEF_MOD("wdt0",		R9A08G045_WDT0_PCLK,
				R9A08G045_CLK_P0,
				MSSR(18, (BIT(0) | BIT(1)), BIT(0))),
	DEF_MOD("wdt1",		R9A08G045_WDT1_PCLK,
				R9A08G045_CLK_P0,
				MSSR(18, (BIT(2) | BIT(3)), BIT(1))),
	DEF_MOD("wdt2",		R9A08G045_WDT2_PCLK,
				R9A08G045_CLK_P0,
				MSSR(18, (BIT(4) | BIT(5)), BIT(2))),
	DEF_MOD("spi-multi",	R9A08G045_SPI_CLK,
				R9A08G045_CLK_SPI1,
				MSSR(20, (BIT(0) | BIT(1) | BIT(2) | BIT(3)),
					 (BIT(0) | BIT(1)))),
	DEF_MOD("sdhi0",	R9A08G045_SDHI0_IMCLK,
				R9A08G045_CLK_SD0,
				MSSR(21, (BIT(0) | BIT(1) | BIT(2) | BIT(3)),
					  BIT(0))),
	DEF_MOD("sdhi1",	R9A08G045_SDHI1_IMCLK,
				R9A08G045_CLK_SD1,
				MSSR(21, (BIT(4) | BIT(5) | BIT(6) | BIT(7)),
					  BIT(1))),
	DEF_MOD("sdhi2",	R9A08G045_SDHI2_IMCLK,
				R9A08G045_CLK_SD2,
				MSSR(21, (BIT(8) | BIT(9) | BIT(10) | BIT(11)),
					  BIT(2))),
	DEF_MOD("usb0",		R9A08G045_CLK_USB0,
				R9A08G045_CLK_P1,
				MSSR(30, (BIT(0) | BIT(2) | BIT(3)),
					 (BIT(0) | BIT(2) | BIT(3)))),
	DEF_MOD("usb1",		R9A08G045_CLK_USB1,
				R9A08G045_CLK_P1,
				MSSR(30, (BIT(1) | BIT(3)),
					 (BIT(1) | BIT(3)))),
	DEF_MOD("eth0",		R9A08G045_ETH0_CLK_AXI,
				R9A08G045_CLK_HP,
				MSSR(31, BIT(0), BIT(0))),
	DEF_MOD("eth1",		R9A08G045_ETH1_CLK_AXI,
				R9A08G045_CLK_HP,
				MSSR(31, BIT(1), BIT(1))),
	DEF_MOD("i2c0",		R9A08G045_I2C0_PCLK,
				R9A08G045_CLK_P0,
				MSSR(32, BIT(0), BIT(0))),
	DEF_MOD("i2c1",		R9A08G045_I2C1_PCLK,
				R9A08G045_CLK_P0,
				MSSR(32, BIT(1), BIT(1))),
	DEF_MOD("i2c2",		R9A08G045_I2C2_PCLK,
				R9A08G045_CLK_P0,
				MSSR(32, BIT(2), BIT(2))),
	DEF_MOD("i2c3",		R9A08G045_I2C3_PCLK,
				R9A08G045_CLK_P0,
				MSSR(32, BIT(3), BIT(3))),
	DEF_MOD("scif0",	R9A08G045_SCIF0_CLK_PCK,
				R9A08G045_CLK_P0,
				MSSR(33, BIT(0), BIT(0))),
	DEF_MOD("scif1",	R9A08G045_SCIF1_CLK_PCK,
				R9A08G045_CLK_P0,
				MSSR(33, BIT(1), BIT(1))),
	DEF_MOD("scif2",	R9A08G045_SCIF2_CLK_PCK,
				R9A08G045_CLK_P0,
				MSSR(33, BIT(2), BIT(2))),
	DEF_MOD("scif3",	R9A08G045_SCIF3_CLK_PCK,
				R9A08G045_CLK_P0,
				MSSR(33, BIT(3), BIT(3))),
	DEF_MOD("scif4",	R9A08G045_SCIF4_CLK_PCK,
				R9A08G045_CLK_P0,
				MSSR(33, BIT(4), BIT(4))),
	DEF_MOD("scif5",	R9A08G045_SCIF5_CLK_PCK,
				R9A08G045_CLK_P0,
				MSSR(33, BIT(5), BIT(5))),
	DEF_MOD("sci0",		R9A08G045_SCI0_CLKP,
				R9A08G045_CLK_P0,
				MSSR(34, BIT(0), BIT(0))),
	DEF_MOD("sci1",		R9A08G045_SCI1_CLKP,
				R9A08G045_CLK_P0,
				MSSR(34, BIT(1), BIT(1))),
	DEF_MOD("gpio",		R9A08G045_GPIO_HCLK,
				CLK_XINCLK,
				MSSR(38, BIT(0), (BIT(0) | BIT(1) | BIT(2)))),
	DEF_MOD("rspi0",	R9A08G045_RSPI0_CLKB,
				R9A08G045_CLK_P0,
				MSSR(36, BIT(0), BIT(0))),
	DEF_MOD("rspi1",	R9A08G045_RSPI1_CLKB,
				R9A08G045_CLK_P0,
				MSSR(36, BIT(1), BIT(1))),
	DEF_MOD("rspi2",	R9A08G045_RSPI2_CLKB,
				R9A08G045_CLK_P0,
				MSSR(36, BIT(2), BIT(2))),
	DEF_MOD("canfd",	R9A08G045_CANFD_PCLK,
				R9A08G045_CLK_P4,
				MSSR(37, (BIT(0) | BIT(1)), (BIT(0) | BIT(1)))),
	DEF_MOD("adc",		R9A08G045_ADC_PCLK,
				R9A08G045_CLK_TSU,
				MSSR(42, (BIT(0) | BIT(1)), (BIT(0) | BIT(1)))),
	DEF_MOD("tsu",		R9A08G045_TSU_PCLK,
				R9A08G045_CLK_TSU,
				MSSR(43, BIT(0), BIT(0))),
};
